...
const STEPS = [
  ...
  { icon: SettingsIcon, title: "Настройки", text: "Тёмная тема, уведомления и «Я на больничном»: пока включено, план на паузе, а после выхода продолжится с того же места. Наставник получит уведомление." },
];
