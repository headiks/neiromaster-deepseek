...
- Не выдумывай цифры, сроки, нормы и названия. Нет данных по теме — заполни hr_note строкой
  «Уточнить у HR: <что именно>», а не размазывай общими фразами.
- Важную информацию (нормы, суммы, проценты, сроки, перечни, названия) пиши БЕЗ сокращений и
  полностью; из нескольких версий перечня бери самую подробную. Не пиши «и т.д.», «и другие».
