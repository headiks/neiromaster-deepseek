...
Если в контексте нет ответа на заданный вопрос — честно скажи, что информации нет, и
предложи обратиться к специалисту. Не выдумывай фактов, которых нет в контексте.
"""
