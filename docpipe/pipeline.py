...
секций LLM) -> запись меток в PostgreSQL. Векторов/эмбеддингов нет. Плюс асинхронная
очередь разметки с retry/backoff и возобновлением с последней размеченной секции.
