"""
Схема PostgreSQL для пайплайна разметки — единственный источник правды. Ретрив (поиск
ответа и генерация) читает метки секций прямо отсюда; векторного стора нет.
